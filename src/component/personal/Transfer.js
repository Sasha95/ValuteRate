  ...
  render() {
    return this.props.testStore.dataForDesktop[0] === undefined ? (
      ...
      <div className="container box">
        ...
        <div className="row pl-0 m-0" id="ButtonTrans">
          <div className="smallInfo">Мой счет</div>
        </div>
        <div className="row p-0 m-0">
          <div
            className="col"
          ...
          >
            ...
            <span className="scoreText">{data["score"]}</span>
          </div>
          <div className="col-auto pt-3 px-0 mr-2" id="ButtonTrans">
            <ButtonToday onClick={this.withdrawalOfFunds}>
              Вывод средств
            </ButtonToday>
          </div>
          <div className="col-auto px-0 py-3" id="ButtonTrans">
            <ButtonAdd onClick={this.addFacilities}>
              Добавить средства
            </ButtonAdd>
          </div>
        </div>
        ...
        {transferDta.map((i, key) => (
          <div key={key} className="container">
            <div className="row mx-3 align-items-center">
              ...
              >
                {i["sum"] < 0 ? "-" : "+"} {i["valute"]} {Math.abs(i["sum"])}{" "}
              </div>
            </div>
            <hr />
          </div>
